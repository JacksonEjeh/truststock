        ...
        <FadeInSection>
            <div className='p-5 pt-20'>
                ...
                <div className='mb-5'>
                    ...
                    <p className='text-sm'>gabbyjax7@gmail.com</p>
                </div>
                <div className='mb-5'>
                ...
                <div className='mb-3'>
                    <p className='font-light text-sm'>Address <span className='text-xs text-blue-500'>copy</span></p>
                ...
                <div className='mb-5'>
                    <p className='font-light text-sm'>Currency amount <span className='text-xs text-blue-500'>copy</span></p>
                    <p className='text-sm'>0.00006</p>
                </div>
                <div>
